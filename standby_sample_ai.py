...
X = [
    [1, 1, 1, 0, 1],  # unsafe config
    [0, 0, 0, 1, 0],  # safe config
    [1, 0, 1, 0, 1],  # unsafe config
    [0, 1, 0, 1, 0],  # unsafe config
    [1, 1, 0, 0, 1],  # unsafe config
    [0, 0, 1, 1, 0],  # unsafe config
    [0, 1, 1, 0, 1],  # unsafe config
    [1, 0, 0, 1, 0]   # safe config
]
y = [1, 0, 1, 1, 1, 1, 1, 0]  # labels: 1 = unsafe, 0 = safe
